					...
					<slot name="left">
						<view class="header_left_info" :class="[isTwoBtn ? 'header_btnMongol' : '' , isWhite && isTwoBtn ? 'header_colorWhite_btnMongol' : '']" v-if="back || $slots.left || home">
							<view class="header_left_back" :class="[ isTwoBtn ? 'header_btnMongol_left_back' : '' ]" v-if="back && !firstPage" @click="onBackPage">
								<image class="header_icon" v-if="isWhite" src="/static/nav-bar/icon_back_white.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/nav-bar/icon_back_black.png" mode="aspectFit"></image>
							</view>
							...
							<view class="header_left_home" :class="[isTwoBtn ? 'header_btnMongol_left_home' : '']" v-if="(firstPage && back) || home" @click="onBackHome">
								<image class="header_icon" v-if="isWhite" src="/static/nav-bar/icon_home_white.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/nav-bar/icon_home_black.png" mode="aspectFit"></image>
							</view>
						</view>
					</slot>
...
const mainPagePath = ['pages/index/index', 'pages/me/me', 'pages/feeds/feeds', 'pages/store/store'];
//返回首页的地址
